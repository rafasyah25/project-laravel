...
<!--external css-->
<link href="{{ url('template/lib/font-awesome/css/font-awesome.css') }}" rel="stylesheet" />
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 p404 centered">
        <img src="{{ url('template/img/404.png') }}" alt="">
        <h1>DON'T PANIC!!</h1>
...
<script src="{{ url('template/lib/bootstrap/js/bootstrap.min.js') }}"></script>
</body>
